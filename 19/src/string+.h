...
/**
 * @brief check if any character in 'chars' is present on string 'str'
 * @param str: pointer to string
 * @param cahr: c string containing hte char to look for 
*/
bool string_contains(const string *str, const char *chars);
